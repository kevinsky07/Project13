...
The files in this repository were used to configure the network depicted in the attachments.

https://drive.google.com/drive/u/0/folders/1rgT81TZGAVLwtyGvGtLQGLrfNIK7uapT
...
Integrating an ELK server allows users to easily monitor the  VMs for changes to the log files and system metrics.

The configuration details of each machine may be found below.

| Name                 | Function           | Private IP Address | Public IP Address | Operating System |
|----------------------|--------------------|--------------------|-------------------|------------------|
| Jump-Box-Provisioner | Gateway            | 10.1.0.4           | 40.112.134.128    | Ubuntu LTS 18.04 |
| Web-1                | Application Server | 10.1.0.7           | 40.112.128.94     | Ubuntu LTS 18.04 |
| Web-2                | Application Server | 10.1.0.8           | 104.42.251.43     | Ubuntu LTS 18.04 |
| elk-stack            | ELK Stack          | 10.4.0.6           | 40.121.159.166    | Ubuntu LTS 18.04 |
